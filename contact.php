...
<section class="faq" id="faq">
   ...
   <div class="box-container">
      ...
      <div class="box active">
         ...
         <p>Before attempting to cancel, review the cancellation policy of the service or business you booked with. The cancellation policy will often dictate the rules and timelines for canceling without incurring fees or penalties.</p>
      </div>

      <div class="box active">
         <h3><span>when will I get the possession?</span><i class="fas fa-angle-down"></i></h3>
         <p>The possession date is the day on which the buyer receives ownership. This date should be mentioned in the draft agreement as specified by RERA norms and rules.</p>
      </div>

      <div class="box">
         <h3><span>where can I pay the rent?</span><i class="fas fa-angle-down"></i></h3>
         <p>By Using Website you can pay the rent</p>
      </div>

      <div class="box">
         <h3><span>how to contact with the buyers?</span><i class="fas fa-angle-down"></i></h3>
         <p>Through our Website we Provide Details of Contact .</p>
      </div>

      <div class="box">
         <h3><span>why my listing not showing up?</span><i class="fas fa-angle-down"></i></h3>
         <p>Try to Refresh the Page and you can able to see the new updates.</p>
      </div>

      <div class="box">
         <h3><span>how to promote my listing?</span><i class="fas fa-angle-down"></i></h3>
         <p>By Uploading the featuristic Images of the Property.</p>
      </div>
